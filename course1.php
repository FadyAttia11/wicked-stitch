      ...
      <form method="post">
        ...
        <?php
          if($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if($get_money && mysqli_num_rows($get_money) > 0) {
              ...
              $updated_money = $current_money['money'] + 110;
              ...
              if($add_money) {
                ...
                $query = "insert into courses (client_id,course_num) values ('$client_id',1)";
                $result = mysqli_query($con, $query);
          
                if($result) {
                  header('Location: course1-data.php');
                } else {
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Enroll Course 1: Fashion Course by Shanee Beery ($110)</h4>
