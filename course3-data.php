  ...
  <section style="margin-top: 50px;">
    <div class="container mt-3"><br>
        ...
        <video width="400" controls>
            <source src="./courses/course3/video1.mp4" type="video/mp4">
            <source src="mov_bbb.ogg" type="video/ogg">
            Your browser does not support HTML video.
        </video>
        <h5>- Video 2: Draping Convertible Collar</h5>
        <video width="400" controls>
            <source src="./courses/course3/video2.mp4" type="video/mp4">
            <source src="mov_bbb.ogg" type="video/ogg">
            Your browser does not support HTML video.
        </video>
        <h5>- Video 3: Short overview of Fashion Draping-Basics course</h5>
        <video width="400" controls>
            <source src="./courses/course3/video3.mp4" type="video/mp4">
            <source src="mov_bbb.ogg" type="video/ogg">
            Your browser does not support HTML video.
        </video>
        <h5>- Video 4: Basic skirt: Marking the darts on the front</h5>
        <video width="400" controls>
            <source src="./courses/course3/video4.mp4" type="video/mp4">
            <source src="mov_bbb.ogg" type="video/ogg">
            Your browser does not support HTML video.
        </video>
        <h5>- Video 5: Verifying Basic bodice</h5>
        <video width="400" controls>
            <source src="./courses/course3/video5.mp4" type="video/mp4">
            <source src="mov_bbb.ogg" type="video/ogg">
            Your browser does not support HTML video.
        </video>
        <h5>- Video 6: Princess bodice: draping back center panel</h5>
        <video width="400" controls>
            <source src="./courses/course3/video6.mp4" type="video/mp4">
            <source src="mov_bbb.ogg" type="video/ogg">
            Your browser does not support HTML video.
        </video>
        <h5>- Video 7: Shift dress draping: preparing front fabric piece</h5>
        <video width="400" controls>
            <source src="./courses/course3/video7.mp4" type="video/mp4">
            <source src="mov_bbb.ogg" type="video/ogg">
            Your browser does not support HTML video.
        </video>
