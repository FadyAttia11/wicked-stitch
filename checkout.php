...
<body>
  ...
  <div class="container mb-5" style="max-width: 400px; margin-top: 100px;">
    <h1>Checkout</h1>
    <h3>for: <?php echo $current_product['title'] ?></h3>
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if($get_money && mysqli_num_rows($get_money) > 0) {
                ...
                if($add_money) {
                    ...
                    $add_purchased_query = "insert into purchased (product_id,product_title,client_id,client_name,price,location,day) values ('$product_id','$product_title', '$client_id','$user_name','$price','$location','$day')";
